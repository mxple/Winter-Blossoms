...
yb += 80;
draw_text_transformed_color(2*GUI_W/7, yb, "Story Writing",1.8,1.8,0,c,c,c,c,alpha-0.2);
yb+=5;
draw_text_transformed_color(2*GUI_W/7, yb, "\nAlex Mehta",1.5,1.5,0,c,c,c,c,alpha-0.3);

draw_text_transformed_color(5*GUI_W/7, yb, "Music",1.8,1.8,0,c,c,c,c,alpha-0.2);
yb+=5;
draw_text_transformed_color(5*GUI_W/7, yb, "\nOnline Assets",1.5,1.5,0,c,c,c,c,alpha-0.3);
yb += 80;
...
draw_text_transformed_color(5*GUI_W/7, yb, "Textures",1.8,1.8,0,c,c,c,c,alpha-0.5);
yb+=5;
draw_text_transformed_color(5*GUI_W/7, yb, "\nEric Li",1.5,1.5,0,c,c,c,c,alpha-0.6);
draw_text_transformed_color(5*GUI_W/7, yb, "\n\nOnline Assets",1.5,1.5,0,c,c,c,c,alpha-0.6);
